...
export default function StepOne() {
  return (
    <div>
      ...
      <h6><strong>Business Name:</strong> <span className="fading">McDonald's</span></h6>
      <h6><strong>Date:</strong>  <span className="fading">10/27/2019</span></h6>
      <h6><strong>Donated Items:</strong>  <span className="fading">Buns, lettuce, tomatoes, ketchup</span></h6>
